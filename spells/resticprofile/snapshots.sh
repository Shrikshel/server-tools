...
log_info "Running: resticprofile -c $ST_RESTIC_PROFILE_FILE -n $profile snapshots"
echo
resticprofile -c "$ST_RESTIC_PROFILE_FILE" -n "$profile" snapshots || log_error "Failed to run resticprofile snapshots"
echo